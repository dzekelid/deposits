...
- name: Capital One DevExchange - Delete a specific existing deposit
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deposits/master/_listings/capital-one-devexchange/depositsid-delete-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/deposits/master/_listings/capital-one-devexchange/depositsid-delete-openapi.md
x-common:
- type: x-api-gallery
